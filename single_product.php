...
$obj_adminBack = new adminBack();
    if(isset($_POST['addtocart'])){
        $return_mesg=$obj_adminBack->addtocart($_POST);
    }
    ...
    <div class="page-contain">
                            ...
                            <div>
                                ...
                                <div class="sumary-product single-layout">
                                    ...
                                    <div class="product-attribute">
                                        ...
                                        <input type="hidden" class="input-qty" name="price" id="price" value="<?=$pro['pdt_price']?>" required>    
                                    </div>
                                        <div class="qty" >
                                                        <label for="cart[id123][qty]">Qty:</label>
                                                        <input type="number" class="input-qty" name="qty" id="qty" onChange="gettotalprice()" required>
                                                    </div>
                                  ...
                                  <h4 align="center" style="color:green;">  <?php
        if(isset($return_mesg)){
            echo $return_mesg;
                                        ...
                                        <input type="hidden" name="pdt_id" value="<?php echo $pro['pdt_id']; ?>">
                                            ...
                                            <input type="hidden" name="ctg_name" value="<?php echo $pro['ctg_name']; ?>">
                                            <input type="hidden" name="pdt_des" value="<?php echo $pro['pdt_des']; ?>">

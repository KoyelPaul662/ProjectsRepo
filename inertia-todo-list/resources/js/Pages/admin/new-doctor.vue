<script setup>
    ...
    function submit(){
        router.post('/new-doctor',form);
        form.name=null; 
        form.address=null; 
        form.specialization_id='Select Specialization';
        form.day='Select Days';
        form.phone=null;
        form.email=null;
        form.time=null;
        form.totime=null;
                ...
                <div class="col-10 col-sm-8 col-md-12 m-auto">
                    <div class="card border-0 shadow py-4">
                        <div class="card-body mx-3">
                            <h4 class="text-uppercase text-dark text-left fw-bold fs-5"> New Doctor : </h4> 
                            ...
                            <form @submit.prevent="submit" enctype="multipart/form-data">
                                ...
                                <select name="day" id="day" class="form-control my-2 py-2 rounded-2 mt-3" v-model="form.day">
                                  ...
                                  <input type="time" class="form-control my-2 py-2 rounded-2" name="time" id="time" v-model="form.time" placeholder="Time" />
                                  <p class="text-left text-danger" v-if="errors.time">{{ errors.time }}</p>

                                  <label>Time To:</label>
                                  <input type="time" class="form-control my-2 py-2 rounded-2" name="totime" id="totime" v-model="form.totime" placeholder="Time" />

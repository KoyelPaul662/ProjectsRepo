...
class HospitalController extends Controller
{
    ...
    public function AllRequest(Request $req){          
         ...
         //dd($doctorids);
         $datareq = Requests::orderBy('id','desc');
         $datareq= $datareq->where('doctorid','Like',"%$doctorids%")->paginate(5); 
         return Inertia::render('doctor/all-request',compact('datareq'));
    }
    ...
    public function DoctorDynamicData(Request $req){
        ...
        $totalpenreq = Requests::where('doctorid','=',$doctorids)->where('status','=','P')->get();
        $totalpenreq= count($totalpenreq);
        ...
        return Inertia::render('doctor/doctordashboard',compact('totalreq','totalapreq','totalcanreq','totalRejreq','totalpenreq'));
    }
